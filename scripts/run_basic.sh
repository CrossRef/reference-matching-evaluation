...
python3 dataset/generate_dataset.py -l ieee -s $WORKING_DIR/sample.json -o $WORKING_DIR/dataset.json
python3 matching/match_references.py -d $WORKING_DIR/dataset.json -o $WORKING_DIR/matched.json
python3 evaluation/evaluate.py -d $WORKING_DIR/matched.json
